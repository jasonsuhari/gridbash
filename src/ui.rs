...
pub fn draw(frame: &mut Frame<'_>, app: &App) -> DrawState {
    ...
    let status = Line::from(vec![
        ...
        Span::raw(
            " | Alt+k commands | Alt+h help | Alt+l resize | Alt+n new | Alt+t tab | Alt+Shift+t restart | Alt+c CLI | Alt+Shift+V voice | Alt+p summary | Alt+Shift+p panes | Alt+x swap | Alt+z sleep | Alt+q quit",
        ),
    ]);
    frame.render_widget(
