# GridBash Launch Spoken Script

This is the selected source-derived narration. Timing and exact take boundaries
remain authoritative in `edit-manifest.json` and `assets/captions.json`.

1. If you have less than ten Claude sessions open at a time, you're not going to make it.
2. I was token-maxing, tired of juggling terminals and forgetting context.
3. So I built GridBash: a beautiful grid for CLI coding agents.
