...
- References issues #27, #29, #30, and #34.
...
- The pane title now shows a compact filled-dot icon for quiet panes.
- Quiet panes use a palette-controlled border color instead of a text badge or footer count.
